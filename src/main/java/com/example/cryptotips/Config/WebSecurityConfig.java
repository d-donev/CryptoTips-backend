//package com.example.cryptotips.Config;
//
//import com.example.cryptotips.Config.Filters.JWTAuthorizationFilter;
//import com.example.cryptotips.Config.Filters.JwtAuthenticationFilter;
...
//        http.csrf().disable()
//                .authorizeRequests()
//                .antMatchers("/", "/home", "/assets/**", "/register", "/api/login","/api/post", "/api/login").permitAll()
